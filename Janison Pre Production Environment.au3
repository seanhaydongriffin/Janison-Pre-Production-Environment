...
Local $app_name = "Janison Pre Production Environment"
...
$storage_format = '<a href=\"https://janisoncls.atlassian.net/wiki/download/attachments/494207048/Janison%20Pre%20Production%20Environment%20portable.exe\">Click to update page</a><br /><br />'
...
Local $deployment = _OctopusGetLatestTenantIdsDeploymentIdTaskIdCreatedForEnvironment("Environments-23")
...
for $subscription_num = 0 to (UBound($subscription_arr) - 1)
	...
	$ps_script_arr[1] = "Get-AzureRmResource -ResourceType 'Microsoft.Sql/servers' -ResourceGroupName '*-BETA*'"
...
Update_Confluence_Page("https://janisoncls.atlassian.net", "JAST", "495845841", "495714943", "Pre-Production (Beta) Environment", $storage_format)
